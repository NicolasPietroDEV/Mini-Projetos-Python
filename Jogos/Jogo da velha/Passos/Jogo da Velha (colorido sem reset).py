...
def quadro():
    ...
    print(f"                                 \033[1;36m      a\033[m  {c1} | {c2} | {c3}")
    print(f"                                         -----------")
    print(f"                                 \033[1;36m      b\033[m  {c4} | {c5} | {c6}")
    print(f"                                         -----------")
    print(f"                                 \033[1;36m      c\033[m  {c7} | {c8} | {c9}")
while True:
    winx = 0
    wino = 0
    c1 = blank
    ...
    while True:
        ...
        while escolhido != 1:
            ...
            quadro()
            print("")
            escolhax = input("                                     \033[34mVez do Player 1:\033[m ")
            if escolhax == "a1":
                if c1 != blank:
        ...
        while escolhido != 1:
            ...
            quadro()
            print("")
            escolhao = input("                                     \033[31mVez do Player 2:\033[m ")
            if escolhao == "a1":
                if c1 != blank:
                    print("Esta casa já foi escolhida (Pressione Enter)")
                    input("")
    ...
    while True:
        ...
        if jogardenovo == "N":
            ...
            break
        if jogardenovo != "S" or jogardenovo != "N":
